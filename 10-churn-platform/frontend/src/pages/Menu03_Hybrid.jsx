      ...
      {result && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="rounded-lg border border-neutral-800 bg-[#121416] p-4 space-y-3">
            ...
            <div className="p-3.5 rounded border border-neutral-800 bg-[#0c0d0e] text-center">
              <span className="text-[10px] font-mono uppercase text-neutral-500">Calibrated Churn Prob</span>
              <div className="text-3xl font-mono font-semibold text-neutral-100 my-1 tabular-nums">
                {result.churn_percentage}
              </div>
              <span className="px-2 py-0.5 rounded text-[11px] font-mono font-medium bg-neutral-800 text-neutral-300">
            ...
            <div className="space-y-1.5 text-xs font-mono">
              <div className="flex justify-between p-2 rounded bg-[#0c0d0e] border border-neutral-800/80">
                ...
                <span className="text-neutral-200">{result.transactions}</span>
              </div>
              <div className="flex justify-between p-2 rounded bg-[#0c0d0e] border border-neutral-800/80">
                <span className="text-neutral-500">Active Days:</span>
                <span className="text-neutral-200">{result.active_days} / 30</span>
              </div>
              <div className="flex justify-between p-2 rounded bg-[#0c0d0e] border border-neutral-800/80">
                <span className="text-neutral-500">Inactive Days:</span>
                <span className="text-neutral-200">{result.inactive_days} / 30</span>
              </div>
            </div>
          ...
          <div className="md:col-span-2 rounded-lg border border-neutral-800 bg-[#121416] p-4 flex flex-col justify-between">
            <div>
