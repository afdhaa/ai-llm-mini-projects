      ...
      <div className="border-b border-neutral-200 pb-5">
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 border border-neutral-200 bg-white rounded-md px-2.5 py-1 text-xs shadow-sm">
              <span className="text-[11px] text-neutral-500 font-mono">Test Case:</span>
              <select
                value={selectedCaseId}
                onChange={(e) => setSelectedCaseId(e.target.value)}
                className="bg-transparent text-neutral-900 font-mono text-xs focus:outline-none cursor-pointer"
              >
                {dataset.map((c) => (
      ...
      {result && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-4 rounded-lg border border-neutral-200 bg-white space-y-3 shadow-sm">
              ...
              <div className="space-y-1.5 text-xs font-mono">
                <div className="flex justify-between p-2 rounded bg-neutral-50 border border-neutral-100">
                  ...
                  <span className="text-neutral-900">{result.pillar1_deterministic_rules.domain_validity ? "PASSED" : "FAILED"}</span>
                </div>
                <div className="flex justify-between p-2 rounded bg-neutral-50 border border-neutral-100">
                  <span className="text-neutral-500">Bounds Calibration [0.0 - 1.0]:</span>
                  <span className="text-neutral-900">{result.pillar1_deterministic_rules.numerical_bounds ? "PASSED" : "FAILED"}</span>
                </div>
                <div className="flex justify-between p-2 rounded bg-neutral-50 border border-neutral-100">
                  <span className="text-neutral-500">Zero Code Leakage:</span>
                  <span className="text-neutral-900">{result.pillar1_deterministic_rules.anti_code_leakage ? "PASSED" : "FAILED"}</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg border border-neutral-200 bg-white space-y-3 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs font-mono text-center">
                <div className="p-2.5 rounded bg-neutral-50 border border-neutral-200">
                  ...
                  <div className="text-xl font-bold text-neutral-900 mt-0.5 tabular-nums">
              ...
              <p className="text-xs text-neutral-700 bg-neutral-50 p-2.5 rounded border border-neutral-200 leading-relaxed font-sans">
                {result.pillar2_llm_judge.judge_rationale}
              </p>
            </div>
          </div>

          <div className="p-3 rounded border border-neutral-200 bg-white shadow-sm flex justify-between text-xs font-mono text-neutral-500">
