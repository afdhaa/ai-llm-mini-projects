    ...
    <Dialog.Root open={isModalOpen} onOpenChange={setIsModalOpen}>
      <Dialog.Portal>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <Dialog.Popup className="w-full max-w-lg rounded-xl border border-neutral-200 bg-white p-6 shadow-2xl text-neutral-900 focus:outline-none">
            {/* Header */}
            ...
            {/* Presets Grid */}
            <div className="mt-4">
              <label className="text-[11px] font-semibold uppercase tracking-wider text-neutral-500 block mb-2 font-mono">
                Provider Presets
              </label>
              <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
                {Object.entries(PRESETS).map(([key, p]) => {
                  ...
                  return (
                    ...
                    >
                      <div className="truncate text-[11px] font-semibold">{p.label.split("(")[0].trim()}</div>
                      <div className={`truncate text-[10px] font-mono mt-0.5 ${isSelected ? "text-neutral-300" : "text-neutral-500"}`}>{p.model}</div>
                    </button>
                  );
                })}
              </div>
            ...
            <div className="mt-5 space-y-3.5">
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-neutral-300 bg-neutral-50 px-3 py-2 text-xs text-neutral-900 focus:bg-white focus:border-neutral-500 focus:outline-none"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-neutral-300 bg-neutral-50 px-3 py-2 text-xs font-mono text-neutral-900 placeholder-neutral-400 focus:bg-white focus:border-neutral-500 focus:outline-none"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-neutral-300 bg-neutral-50 px-3 py-2 text-xs font-mono text-neutral-900 focus:bg-white focus:border-neutral-500 focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-lg border border-neutral-300 bg-neutral-50 px-3 py-2 pr-10 text-xs font-mono text-neutral-900 placeholder-neutral-400 focus:bg-white focus:border-neutral-500 focus:outline-none"
                  />
                  <button
                    type="button"
            ...
            {connStatus && (
              ...
              >
                ...
                {connStatus.latency_ms != null && (
                  <span className="font-mono text-[11px] text-neutral-500 flex-shrink-0">
            ...
            <div className="mt-6 flex items-center justify-between pt-4 border-t border-neutral-200">
              <button
                ...
                className="rounded-lg border border-neutral-200 bg-white hover:bg-neutral-50 px-3 py-2 text-xs font-medium text-neutral-700 transition shadow-sm disabled:opacity-50"
              >
                {connStatus?.testing ? "Verifying..." : "Ping Endpoint"}
              </button>
              <Dialog.Close className="rounded-lg bg-neutral-900 hover:bg-neutral-800 text-white px-4 py-2 text-xs font-semibold shadow-sm transition active:scale-[0.99]">
                Apply Settings
              </Dialog.Close>
            </div>
          </Dialog.Popup>
